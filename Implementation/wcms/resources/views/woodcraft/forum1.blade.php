    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse align-right" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
              <li class="nav-item">
                <a class="nav-link link text-black display-5" style="color: #55b4d4;" href="{!! url('wcms') !!}">Home</a>
              </li>
              <li class="nav-item">
...
<div class="container col-md-12">
  ...
  <div class="container col-md-12">
    ...
    <div class="form-group align-right col-md-6" data-for="message">
      <textarea type="text" class="form-control" name="post" rows="5" placeholder="Post as {{Auth::user()->fullname}}" value="" id="message-header15-2"></textarea>
  ...
  <div class="container">
    <div class="container row col-md-12">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-10">
          <div>
            <a href="#"><span class="mbri-like" style="font-size: 18px;"></span></a> 123
          </div>
          ...
          <div>
            &nbsp&nbsp<a href="#"><span class="mbri-like" style="font-size: 18px;"></span></a> 123
          </div>
          @endforeach
        </div>
        </div>
    ...
    <div class="form-group align-right" data-for="message">
      <input type="text" class="form-control align-right" name="reply"  placeholder="Reply as {{Auth::user()->fullname}}" value="" id="message-header15-2">
